...
class Exchange(ABC):
    ...
    def __init__(self, name: str, api_key: str = "", api_secret: str = "", testnet: bool = True):
        self.name = name
    ...
    async def place_market_order(self, symbol: str, side: OrderSide, quantity: float) -> Order:
